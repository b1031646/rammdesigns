...
<html>
	...
	<body>
		...
		<a href="#create-subscription" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<!-- Scaffolded Code -->
		...
		<div id="create-subscription" class="content scaffold-create" role="main">
